...
const { getTokenAndContract, getPairContract, calculatePrice, getEstimatedReturn, getReserves } = require('./helpers/helpers') //get these variables from the helpers file
const { uFactory, uRouter, sFactory, sRouter, web3, arbitrage } = require('./helpers/initialization') //get these variables from initialization file
